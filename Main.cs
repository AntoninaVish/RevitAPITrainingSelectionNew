...
namespace RevitAPITrainingSelectionNew
{
...

    {
        public Result Execute(ExternalCommandData commandData, ref string message, ElementSet elements)
        {
            ...
            Reference selectedElementRef = uidoc.Selection.PickObject(ObjectType.Element, "Выберите элемент");//выбор одного элемента


            //Reference selectedElementRef = uidoc.Selection.PickObject(ObjectType.Face, "Выберите элемент по грани"); прописываем код если хотим выбрать элемент по грани
            //Reference selectedElementRef = uidoc.Selection.PickObject(ObjectType.Edge, "Выберите элемент по ребру"); прописываем код если хотим выбрать элемент по ребру
